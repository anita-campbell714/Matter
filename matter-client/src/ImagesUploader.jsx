    ...
    return (
        <>
            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                    ...
                    addedImages.map((link) => (
                        <div className="relative h-32 flex" key={link}>
                            ...
                            <button
                                ...
                                className="absolute cursor-pointer text-white bg-black  bg-opacity-50 rounded-xl py-1 px-2 bottom-1 right-1"
                            >
                                <svg
                            ...
                            <button
                                ...
                                className="absolute cursor-pointer text-white bg-black  bg-opacity-50 rounded-xl py-1 px-2 bottom-1 left-1"
                            >
                                {link === addedImages[0] && (
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                ...
                <label className="bg-primary flex justify-center items-center gap-1 border bg-transparent rounded-2xl p2 text-2xl text-gray-600 cursor-pointer h-32">
                    <input
                        type="file"
                        multiple
                        className="hidden"
